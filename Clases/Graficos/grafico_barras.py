...
import pandas as p #para el archivo de barrios#
#------------Clase------------#
personas = {
...
plt.xlabel("Nombres") 
plt.ylabel("Pesos (kg)")
plt.savefig("Pesos_pacientes.png") #Mostar el grafico en Visual#
plt.close() 
plt.show()
...
plt.xlabel("Nombres")
plt.ylabel("Pesos (kg)")
figure = plt.gcf() #get current figure (gcf). Para cambiar el tamño de la grafica#
